  ...
  return (
    <div style={{ fontFamily: "'Poppins', sans-serif" }} className="animate-fade-in">
      ...
      <section className="mb-12 animate-slide-in-left">
        <h2 className="text-[#333333] dark:text-white text-4xl font-bold mb-4 relative inline-block">
          About Me
          <span className="absolute bottom-0 left-0 w-12 h-1 bg-[#ef4444]" />
        </h2>
        <div className="mt-6 space-y-4">
          <p className="text-[#555555] dark:text-white text-base leading-relaxed">
      ...
      <section className="mb-12 animate-slide-in-right">
        <h2 className="text-[#333333] dark:text-white text-4xl font-bold mb-8">What I'm Doing</h2>
      ...
      <section className="animate-slide-in-left">
        <h2 className="text-[#333333] dark:text-white text-4xl font-bold mb-8">Testimonials</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <TestimonialCard
            name="Daniel Lewis"
